...
def macro():
	...
	addControl("CheckBox", {"PositionX": 106, "PositionY": 168, "Width": 150, "Height": 8, "Label": "~Enable Close dialog Button", "TriState": True, "State": 1}, {"addItemListener": ItemListener(dialog)})  
...
# 	@enableRemoteDebugging
	def textChanged(self, textevent):  # 複数回呼ばれるので前値との比較が必要。
		...
		if name.startswith("CurrencyField"):	# CurrencyFieldで始まる名前のコントロールに対して。
